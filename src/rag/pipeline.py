...
class RAGPipeline:
    ...
    def _generate_general_knowledge(self, query: str) -> str:
        ...
        """
        prompt = (
            "Based on established medical knowledge, provide a detailed, helpful answer "
            "to the following question. Write in warm, conversational language as if "
            "explaining to a friend or family member.\n\n"
            "Guidelines:\n"
            "- Explain common symptoms or signs in everyday terms that anyone can understand\n"
            "- Include specific, relatable examples that people might notice in daily life\n"
            "- Explain WHY symptoms happen in simple language (e.g., 'because the body is trying to...')\n"
            "- Write a thorough answer with several sentences covering the main points\n"
            "- Be conversational and warm, like talking to someone you care about\n"
        ...
        system_message = (
            "You are a warm, friendly health educator who explains medical topics in simple, "
            "everyday language. You describe symptoms and conditions in a way that someone "
            "without medical training can easily understand, using relatable examples and "
            "explaining the reasons behind common symptoms. Your answers are conversational, "
